...
class DashboardController extends Controller
{
    ...
    public function getStatistic()
    {
        ...
        $averageResolutionTime = Ticket::whereBetween('created_at', [$currentMonth, $endOfMonth])
            ...
            ->select(DB::raw('AVG(TIMESTAMPDIFF(HOUR, created_at, completedAt)) as avg_time'))
            ->value('avg_time') ?? 0;
        ...
        $dashboardData = [
            ...
            'avg_resolution_time' => round($averageResolutionTime,1),
            'status_distribution' => $statusDistribution
        ];

        return response()->json([
            'message' => 'Dashboard get data succes',
